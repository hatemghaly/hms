...
class CreateBedsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Beds", 'beds', 'bed_type', 'fa-cube', [
            ["bed_type", "Bed Type", "Name", false, "", 0, 256, true],
            ["description", "Description", "Textarea", false, "", 0, 0, false],
            ["bed_capacity", "Bed Capacity", "Integer", false, "", 0, 11, true],
            ["charge", "Charge", "Name", false, "", 0, 256, false],
