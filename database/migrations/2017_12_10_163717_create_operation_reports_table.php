...
class CreateOperationReportsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Operation_reports", 'operation_reports', 'patient_id', 'fa-bed', [
            ...
            ["doctor_name", "Doctor Name", "Dropdown", false, "", 0, 0, true, "@doctors"],
    ...
    {
        if (Schema::hasTable('operation_reports')) {
