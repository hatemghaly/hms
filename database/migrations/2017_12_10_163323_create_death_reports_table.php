...
class CreateDeathReportsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Death_reports", 'death_reports', 'doctor_name', 'fa-cube', [
            ["patient_id", "Patient ID", "Dropdown", false, "", 0, 0, false, "@patients"],
            ["date", "Date", "Date", false, "", 0, 0, true],
            ["title", "Title", "Name", false, "", 0, 256, true],
            ["description", "Description", "Textarea", false, "", 0, 0, false],
            ["doctor_name", "Doctor Name", "Dropdown", false, "", 0, 0, false, "@doctors"],
