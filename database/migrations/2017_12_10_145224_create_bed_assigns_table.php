...
class CreateBedAssignsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Bed_assigns", 'bed_assigns', 'patient_id', 'fa-bed', [
            ["patient_id", "Patient ID", "Dropdown", false, "", 0, 0, false, "@patients"],
            ["bed_type", "Bed Type", "Dropdown", false, "", 0, 0, false, "@beds"],
            ["assign_date", "Assign Date", "Date", false, "", 0, 0, true],
            ["discharge_date", "Discharge Date", "Date", false, "", 0, 0, true],
    ...
    {
        if (Schema::hasTable('bed_assigns')) {
