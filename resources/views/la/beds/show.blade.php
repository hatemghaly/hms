...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Beds", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/beds/'.$bed->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Beds", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.beds.destroy', $bed->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/beds') }}" data-toggle="tooltip" data-placement="right" title="Back to Beds"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'bed_capacity')
						@la_display($module, 'charge')
