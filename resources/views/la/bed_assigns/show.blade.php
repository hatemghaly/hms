...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $bed_assign->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Bed_Assigns", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/bed_assigns/'.$bed_assign->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Bed_Assigns", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.bed_assigns.destroy', $bed_assign->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/bed_assigns') }}" data-toggle="tooltip" data-placement="right" title="Back to Bed Assigns"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'bed_type')
						@la_display($module, 'assign_date')
						@la_display($module, 'discharge_date')
