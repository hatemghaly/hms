...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $patient_case_study->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Patient_Case_Studies", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/patient_case_studies/'.$patient_case_study->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Patient_Case_Studies", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.patient_case_studies.destroy', $patient_case_study->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/patient_case_studies') }}" data-toggle="tooltip" data-placement="right" title="Back to Patient Case Studies"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'patient_id')
						@la_display($module, 'food_allergies')
						@la_display($module, 'tendency_bleed')
						@la_display($module, 'heart_disease')
						@la_display($module, 'high_blood_pressure')
						@la_display($module, 'diabetic')
						@la_display($module, 'surgery')
						@la_display($module, 'accident')
						@la_display($module, 'others')
						@la_display($module, 'family_history')
						@la_display($module, 'currenm_medication')
						@la_display($module, 'female_pregnancy')
						@la_display($module, 'breast_feeding')
						@la_display($module, 'health_insurance')
						@la_display($module, 'low_Income')
